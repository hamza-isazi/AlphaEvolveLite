...
def get_initial_program_length():
    """Get the character length of the original initial program."""
    # Use the original initial program from initial_programs/ folder  
    project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    initial_program_path = os.path.join(project_root, "examples", "code_golf", "initial_programs", f"initial_program_task_13.py")
    ...
    print(f"Warning: Could not find original initial program at {initial_program_path}, using default length of 1000")
    return 1000
